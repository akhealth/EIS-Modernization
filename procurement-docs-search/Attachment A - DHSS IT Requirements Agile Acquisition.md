![](media/image1.png){width="1.4908333333333332in" height="1.5in"}
...
services lines to get to done.[[[[[[[[[[]{#_Toc479149612
.anchor}]{#_Toc476213784 .anchor}]{#_Ref476149269
.anchor}]{#_Ref476149243 .anchor}]{#_Ref476148899
.anchor}]{#_Ref476148870 .anchor}]{#_Ref476148825
.anchor}]{#_Ref476148745 .anchor}]{#_Ref476148699
.anchor}]{#_Ref476148641 .anchor}
...
Table - Example technical services components
...
![](media/image8.emf){width="5.829958442694664in" height="3.475in"}
...
[[[]{#_Toc413075002 .anchor}]{#_Toc409615668 .anchor}]{#_Toc390245000
.anchor}We want you to understand that we are working with our federal
partners (the Centers for Medicare and Medicaid Services and the
Administration for Children and Families) to evolve from a traditional
model of program-centric administration based on division-level
technology needs, to a Department-level, enterprise-wide architecture
based on the leveraging of shared technology and business components.
The target result for us is a modular, service-oriented and flexible
Health Information Technology (HIT) architecture, designed to allow the
